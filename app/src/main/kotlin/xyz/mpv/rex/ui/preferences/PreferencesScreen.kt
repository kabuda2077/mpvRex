    ...
    Scaffold(
      ...
      ProvidePreferenceLocals {
        LazyColumn(
          ...
          // RexShorts Section
          item {
            PreferenceSectionHeader(title = stringResource(R.string.pref_category_shorts))
          }

          item {
            PreferenceCard {
              Preference(
                title = { Text(text = stringResource(R.string.pref_shorts_settings_title)) },
                summary = {
                  Text(
                    text = stringResource(R.string.pref_shorts_settings_summary),
                    color = MaterialTheme.colorScheme.outline
                  )
                },
                icon = {
