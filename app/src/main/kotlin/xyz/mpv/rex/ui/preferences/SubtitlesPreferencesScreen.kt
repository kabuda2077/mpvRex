    ...
    Scaffold(
      ...
      ProvidePreferenceLocals {
        ...
        LazyColumn(
          ...
          item {
            PreferenceSectionHeader(title = stringResource(R.string.pref_subtitles_search_header))
          }
            ...
            PreferenceCard {
              ...
              MultiChoicePreference(
                ...
                summary = {
                  val summaryText = if (wyzieSources.isEmpty() || wyzieSources.contains("all")) {
                    stringResource(R.string.pref_subtitles_all_sources)
                  } else {
              ...
              Column(modifier = Modifier.fillMaxWidth()) {
                Row(
                  ...
                  Text(
                    text = stringResource(R.string.pref_subtitles_advanced_search_filters),
                ...
                if (showAdvanced) {
                  Column(modifier = Modifier.padding(horizontal = 16.dp)) {
                    SwitchPreference(
                      ...
                      title = { Text(stringResource(R.string.pref_subtitles_hearing_impaired_friendly)) },
                      summary = { Text(stringResource(R.string.pref_subtitles_hearing_impaired_friendly_summary)) }
                    )
              ...
              Row(
                ...
                Text(
                  text = stringResource(R.string.pref_subtitles_search_provided_by),
                  style = MaterialTheme.typography.bodySmall,
                  color = MaterialTheme.colorScheme.onSurfaceVariant
                )
                Text(
