  ...
  override fun Content() {
    ...
    if (showExportDialog && exportStats != null) {
      AlertDialog(
        ...
        title = { Text(stringResource(R.string.pref_advanced_export_complete_title)) },
        text = {
          Column(
            modifier = Modifier
              .fillMaxWidth()
            ...
            Text(
              stringResource(R.string.pref_advanced_export_complete_summary, exportStats?.totalExported ?: 0)
            )
          }
        },
        confirmButton = {
    ...
    if (showImportDialog && importStats != null) {
      AlertDialog(
        ...
        title = { Text(stringResource(R.string.pref_advanced_import_complete_title)) },
        text = {
          Text(
            stringResource(
              R.string.pref_advanced_import_complete_summary,
    ...
    Scaffold(
      ...
      ProvidePreferenceLocals {
        ...
        LazyColumn(
          ...
          item {
            PreferenceSectionHeader(title = stringResource(R.string.pref_advanced_backup_restore_header))
          }
          
          item {
            PreferenceCard {
              Preference(
                title = { Text(text = stringResource(R.string.pref_advanced_export_settings_title)) },
                summary = { 
                  Text(
                    text = stringResource(R.string.pref_advanced_export_settings_summary),
              ...
              Preference(
                title = { Text(text = stringResource(R.string.pref_advanced_import_settings_title)) },
                summary = { 
                  Text(
                    text = stringResource(R.string.pref_advanced_import_settings_summary),
                    color = MaterialTheme.colorScheme.outline,
                  ) 
                },
                icon = { 
          ...
          item {
            PreferenceSectionHeader(title = stringResource(R.string.pref_advanced_mpv_configuration_header))
          }
          ...
          // Scripts Section
          item {
            PreferenceSectionHeader(title = stringResource(R.string.pref_advanced_scripts_header))
          }
          ...
          item {
            PreferenceCard {
              ...
              SwitchPreference(
                ...
                title = { Text(stringResource(R.string.pref_advanced_enable_lua_scripts)) },
                summary = { 
                  Text(
                    stringResource(R.string.pref_advanced_enable_lua_scripts_summary),
                    color = MaterialTheme.colorScheme.outline,
                  ) 
                },
              )
              ...
              Preference(
                title = { Text(stringResource(R.string.pref_advanced_manage_lua_scripts)) },
                summary = {
                  when {
                    mpvConfStorageLocation.isBlank() || !enableLuaScripts -> Text(
                      stringResource(R.string.pref_advanced_set_storage_location_first), 
                      color = MaterialTheme.colorScheme.outline
                    )
                    ...
                    selectedScripts.size == 1 -> Text(
                      stringResource(R.string.pref_advanced_one_script_enabled),
                      color = MaterialTheme.colorScheme.outline
                    )
                    else -> Text(
                      stringResource(R.string.pref_advanced_multiple_scripts_enabled, selectedScripts.size),
                      color = MaterialTheme.colorScheme.outline
                    )
                  }
                },
              ...
              Preference(
                title = { Text(stringResource(R.string.pref_advanced_custom_lua_title)) },
                summary = {
                  Text(
          ...
          // History Section
          item {
            PreferenceSectionHeader(title = stringResource(R.string.pref_advanced_history_header))
          }
                        ...
                        withContext(Dispatchers.Main) {
                          isConfirmDialogShown = false
                           Toast
                             .makeText(
                               context,
                               context.getString(R.string.pref_advanced_clear_playback_history_failed, error.message ?: ""),
                               Toast.LENGTH_LONG,
                             ).show()
                        }
                      }
          ...
          // Cache Section
          item {
            PreferenceSectionHeader(title = stringResource(R.string.pref_advanced_cache_header))
          }
          ...
          item {
            PreferenceCard {
              ...
              Preference(
                title = { Text(text = stringResource(R.string.pref_advanced_clear_config_cache_title)) },
                summary = { 
                  Text(
                    text = stringResource(R.string.pref_advanced_clear_config_cache_summary),
                    color = MaterialTheme.colorScheme.outline,
                  ) 
                },
                onClick = {
              ...
              if (isClearThumbsConfirmShown) {
                ConfirmDialog(
                  ...
                  subtitle = stringResource(R.string.pref_advanced_clear_thumbnail_cache_confirm_message),
                  onConfirm = {
                    scope.launch(Dispatchers.IO) {
                      runCatching {
                        ...
                        withContext(Dispatchers.Main) {
                          isClearThumbsConfirmShown = false
                          Toast.makeText(context, context.getString(R.string.pref_advanced_clear_playback_history_failed, error.message ?: ""), Toast.LENGTH_LONG).show()
                        }
                      }
                    }
                  },
          ...
          item {
            PreferenceSectionHeader(title = stringResource(R.string.pref_advanced_system_integration_header))
          }
          ...
          item {
            PreferenceCard {
              ...
              SwitchPreference(
                ...
                title = { Text(stringResource(R.string.pref_advanced_enable_media_info_activity)) },
                summary = {
                  Text(
                    stringResource(R.string.pref_advanced_enable_media_info_activity_summary),
                    color = MaterialTheme.colorScheme.outline,
                  )
                },
              )
          ...
          // Logging Section
          item {
            PreferenceSectionHeader(title = stringResource(R.string.pref_advanced_logging_header))
          }
