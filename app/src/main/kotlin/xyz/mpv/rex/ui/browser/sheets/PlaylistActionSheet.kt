...
fun PlaylistActionSheet(
  ...
  ModalBottomSheet(
    ...
    Column(
      ...
      // Title
      Text(
        text = stringResource(id = R.string.playlist_options),
      ...
      Card(
        ...
        Row(
          ...
          Column(modifier = Modifier.weight(1f)) {
            Text(
              text = stringResource(id = R.string.playlist_create_empty),
              style = MaterialTheme.typography.bodyLarge,
              fontWeight = FontWeight.Medium,
            )
            Text(
              text = stringResource(id = R.string.playlist_create_empty_summary),
      ...
      Card(
        ...
        Row(
          ...
          Column(modifier = Modifier.weight(1f)) {
            Text(
              text = stringResource(id = R.string.playlist_add_m3u_url),
              style = MaterialTheme.typography.bodyLarge,
              fontWeight = FontWeight.Medium,
            )
            Text(
              text = stringResource(id = R.string.playlist_add_m3u_url_summary),
              style = MaterialTheme.typography.bodySmall,
              color = MaterialTheme.colorScheme.onSurfaceVariant,
            )
          }
    ...
    Dialog(onDismissRequest = { showCreateDialog = false }) {
      Card(
        ...
        Column(
          ...
          Text(
            text = stringResource(id = R.string.playlist_create_playlist),
            style = MaterialTheme.typography.headlineSmall,
          )
          OutlinedTextField(
            value = playlistName,
                ...
                if (playlistName.isNotBlank()) {
                  coroutineScope.launch {
                    try {
                      ...
                      android.widget.Toast.makeText(
                        context,
                        context.getString(R.string.playlist_created_failed, e.message ?: ""),
      ...
      uri?.let {
        ...
        coroutineScope.launch {
          ...
          result.onSuccess {
            android.widget.Toast.makeText(
              context,
              context.getString(R.string.playlist_add_success),
              android.widget.Toast.LENGTH_SHORT
            ).show()
          }.onFailure { error ->
            android.widget.Toast.makeText(
    ...
    Dialog(onDismissRequest = if (isLoading) { {} } else { onDismiss }) {
      Card(
        ...
        Column(
          ...
          Text(
            text = stringResource(id = R.string.playlist_add_m3u_dialog_title),
            style = MaterialTheme.typography.headlineSmall,
          )
          ...
          Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
            OutlinedTextField(
              ...
              label = { Text(stringResource(id = R.string.playlist_url)) },
              singleLine = false,
              maxLines = 3,
              modifier = Modifier.fillMaxWidth(),
              enabled = !isLoading
            ...
            Row(
              ...
              Text(
                text = stringResource(id = R.string.playlist_or),
            ...
            OutlinedButton(
              ...
              Spacer(modifier = Modifier.width(8.dp))
              Text(stringResource(id = R.string.playlist_choose_local_m3u))
            }
          ...
          Row(
            ...
            Button(
              ...
              Text(stringResource(id = R.string.playlist_add_from_url))
            }
          }
        }
      }
