...
fun AddConnectionSheet(
  ...
  AlertDialog(
    ...
    title = {
      Text(
        text = stringResource(id = R.string.net_add_connection),
    ...
    text = {
      ...
      // Name and Protocol in one row
            Row(
              ...
              OutlinedTextField(
                ...
                label = { Text(stringResource(id = R.string.name), maxLines = 1, overflow = TextOverflow.Ellipsis) },
              ...
              ExposedDropdownMenuBox(
                ...
                OutlinedTextField(
                  ...
                  onValueChange = { },
                  readOnly = true,
                  label = { Text(stringResource(id = R.string.protocol), maxLines = 1, overflow = TextOverflow.Ellipsis) },
      ...
      OutlinedTextField(
        ...
        label = { Text(stringResource(id = R.string.host_ip_address), maxLines = 1, overflow = TextOverflow.Ellipsis) },
        modifier = Modifier.fillMaxWidth(),
        singleLine = true,
      ...
      // Port and Path in one row
            Row(
              ...
              OutlinedTextField(
                ...
                label = { Text(stringResource(id = R.string.port), maxLines = 1, overflow = TextOverflow.Ellipsis) },
              ...
              OutlinedTextField(
                ...
                label = { Text(stringResource(id = R.string.path), maxLines = 1, overflow = TextOverflow.Ellipsis) },
      ...
      Row(
        ...
        Text(stringResource(id = R.string.anonymous_guest_access))
      }
      ...
      if (protocol == NetworkProtocol.WEBDAV) {
        Row(
          ...
          Spacer(modifier = Modifier.width(8.dp))
          Text(stringResource(id = R.string.net_use_https))
        }
      }
            ...
            Row(
              ...
              OutlinedTextField(
                ...
                onValueChange = { username = it },
                 label = { Text(stringResource(id = R.string.username), maxLines = 1, overflow = TextOverflow.Ellipsis) },
                modifier = Modifier.weight(0.50f),
                singleLine = true,
                enabled = !isAnonymous,
              )
              ...
              OutlinedTextField(
                ...
                onValueChange = { password = it },
                 label = { Text(stringResource(id = R.string.password), maxLines = 1, overflow = TextOverflow.Ellipsis) },
                modifier = Modifier.weight(0.50f),
                singleLine = true,
                enabled = !isAnonymous,
              )
